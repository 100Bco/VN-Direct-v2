  ...
  return (
    <header className="relative min-h-screen flex items-center pt-32 pb-20 overflow-hidden bg-black">
      ...
      <div className="absolute inset-0 z-0 overflow-hidden bg-black">
        <div
          className={`absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 pointer-events-none transition-opacity duration-700 w-[max(266vh,100vw)] h-[max(150vh,56.25vw)] md:w-[max(177.77vh,100vw)] md:h-[max(56.25vw,100vh)] ${videoReady ? 'opacity-100' : 'opacity-0'}`}
        >
          <iframe
