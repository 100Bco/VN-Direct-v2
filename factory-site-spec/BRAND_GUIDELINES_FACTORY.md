...
Site nhà máy có section "Đoàn buyers" (4 cards) — đây là **pattern mới** chưa có ở site mẹ. Đề xuất layout:
...
Layout grid: `grid grid-cols-1 md:grid-cols-2 gap-6` (2x2 trên desktop).
...
| **Đoàn buyers** | **XL** | **4 buyer cards full, có ảnh, full bio** ← trọng tâm |
